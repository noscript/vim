...
function Test_rightmargin_double_cell()
  ...
  only!
  enew!
  set list& listchars& wrap& rightmargin& rightleft& ff& columns& breakindent& breakindentopt& expandtab mouse&
endfunction
...
function Test_rightmargin_format_and_align()
  ...
  only!
  enew!
  set rightmargin& wrapmargin& expandtab&
endfunction
...
function Test_rightmargin_motions()
  ...
  " SART: testing g$ / gm / zH / zL / ze / zl / zh
  "-----------------------
...
function Test_rightmargin_textprop_wrapped_virtual_text()
  ...
  set wrap& rightmargin& smoothscroll& scrolloff& showmode& showcmd&
endfunction
